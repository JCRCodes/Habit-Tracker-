...
class AddHabitFrame(ctk.CTkFrame):
    def __init__(self, master, show_main_callback, db):
        ...
        dropdown = ctk.CTkOptionMenu(overlay,
...
class AmendHabitFrame(ctk.CTkFrame):
    def __init__(self, master, habit_data, show_view_habits_callback, db):
        ...
        # Add your widgets here (entries pre-filled with habit_data)
    ...
    def update_habit(self):
        # Get updated values and call self.db.update_habit(...)
        pass

    def delete_habit(self):
        # Confirm and call self.db.delete_habit(...)
        pass
